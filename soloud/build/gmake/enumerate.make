...
MAKEFILE = enumerate.make

ifeq ($(config),debug)
  OBJDIR              = debug/Debug/enumerate
  TARGETDIR           = ../../bin
  TARGET              = $(TARGETDIR)/enumerate
  DEFINES            += -DDEBUG
  INCLUDES           += -I"../../include"
  ...
  ALL_LDFLAGS        += $(LDFLAGS) -L"." -L"../../lib"
  LIBDEPS            += ../../lib/libsoloud_static.a
  LDDEPS             += ../../lib/libsoloud_static.a
  LDRESP              =
  LIBS               += $(LDDEPS) -lasound -lpthread -ldl
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
ifeq ($(config),release)
  OBJDIR              = release/Release/enumerate
  TARGETDIR           = ../../bin
  TARGET              = $(TARGETDIR)/enumerate
  DEFINES            += -DNDEBUG
  INCLUDES           += -I"../../include"
