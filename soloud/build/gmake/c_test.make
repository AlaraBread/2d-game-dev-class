...
ifeq ($(config),debug)
  ...
  LDRESP              =
  LIBS               += $(LDDEPS) -lpthread -ldl -lasound
  EXTERNAL_LIBS      +=
  LINKOBJS            = $(OBJECTS)
...
$(OBJDIR)/demos/c_test/main.o: ../../demos/c_test/main.c $(OBJDIR)/src/c_api
	@echo $(notdir $<)
	mkdir -p $(OBJDIR)/demos/c_test
	touch $(OBJDIR)/demos/c_test/main.d
	$(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -c "$<"
